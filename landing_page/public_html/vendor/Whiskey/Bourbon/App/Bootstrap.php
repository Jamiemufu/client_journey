...
class Bootstrap
{
    ...
    protected function _checkDependencies()
    {
        ...
        $messages =
            [
                ...
                'json_check'            => 'The php5-json library',
                'curl_check'            => 'The php5-curl library',
     ...
     */
    protected function _loadConfigurationFiles($dot_env_location)
    {
        ...
        try
        {
            ...
            {
                $dot_env_location = realpath($dot_env_location);
                $dot_env_file     = basename($dot_env_location);
                $dot_env_dir      = mb_substr($dot_env_location, 0, (0 - mb_strlen($dot_env_file)));
            }
    ...
    protected function _checkForSpecialPages()
    {
        ...
        if ($this->_runningFromCli() AND
            $this->_dependencies->router->isCurrentUrl(Cli::getPath()))
        {
            new Cli();
            exit;
        }
     ...
     */
    protected function _runningFromCli()
    {
    ...
    public function execute($dot_env_location = null, $full_run = true)
    {
        ...
        if ($full_run)
        {
            ...
            /*
             * Show the dashboard widget, if in the development environment, not
             * responding to an AJAX request and where the body contains HTML
             */
