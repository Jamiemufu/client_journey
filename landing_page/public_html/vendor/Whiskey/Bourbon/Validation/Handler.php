...
class Handler
{
     ...
     */
    public function __construct(Validators $validators, FlashMessage $flash_message, Builder $builder)
    {
    ...
    public function addCustomValidator($type = '', Closure $callback, $message = 'is not valid')
    {
        ...
        static::$_custom_validators[$type] = ['type'     => $type,
                                              'callback' => $callback,
                                              'message'  => $message];
    ...
    public function addError($keys = '', $message = '')
    {
        ...
        foreach ($keys as $key)
        {
            ...
            if (isset($this->_form_array[$key]))
            {
                ...
                $this->_custom_errors[$key][] = ['value'   => $this->_form_array[$key],
                                                 'message' => $message];
    ...
    protected function _needsRecheck()
    {
        ...
        $new_hash = ['input'     => $this->_form_array,
