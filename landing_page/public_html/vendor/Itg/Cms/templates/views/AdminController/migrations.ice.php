                    ...
                    @foreach ($migrations as $migration)
                        ...
                        <tr>
                            ...
                            <td class="actions-cell">
                                @if (!$is_current)
                                    <a href="{{ $_helper->_link(AdminController::class, 'migrate_to', $migration->getId()) }}?csrf_token={csrf}" data-toggle="tooltip" class="btn btn-default btn-xs tooltips confirm-link" data-original-title="Migrate {{ ucwords($direction) }}">
