            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="actions-cell">
                        ...
                        <a href="{{ $_helper->_link(AdminController::class, 'backups_site', 'delete', $backup->time) }}?csrf_token={csrf}" data-toggle="tooltip" class="btn btn-default btn-xs tooltips confirm-link" data-original-title="Delete">
