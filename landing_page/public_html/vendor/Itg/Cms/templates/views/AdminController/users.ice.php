                ...
                @foreach ($users as $user)
                    <tr>
                        ...
                        <td class="actions-cell">
                            ...
                            <a href="{{ $_helper->_link(AdminController::class, 'delete_user', $user->id) }}?csrf_token={csrf}" data-toggle="tooltip" class="btn btn-default btn-xs tooltips hidden-xs confirm-link" data-original-title="Delete">
